...
//EV曝光补偿设置参数表，支持7个等级
const static u8 OV5640_EXPOSURE_TBL[7][6] = { 0x10, 0x08, 0x10, 0x08, 0x20, 0x10, 	//-3
...
//灯光模式参数表,支持5个模式
const static u8 OV5640_LIGHTMODE_TBL[5][7] = { 0x04, 0X00, 0X04, 0X00, 0X04, 0X00, 0X00, //Auto,自动
...
//色彩饱和度设置参数表,支持7个等级
const static u8 OV5640_SATURATION_TBL[7][6] = { 0X0C, 0x30, 0X3D, 0X3E, 0X3D, 0X01, //-3
...
//特效设置参数表,支持7个特效
const static u8 OV5640_EFFECTS_TBL[7][3] = { 0X06, 0x40, 0X10,	//正常
	0X1E, 0xA0, 0X40,	//冷色
	0X1E, 0x80, 0XC0,	//暖色
	0X1E, 0x80, 0X80,	//黑白
	0X1E, 0x40, 0XA0,	//泛黄
